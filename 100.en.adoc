...
* Engage with scientific leaders in biodiversity sciences to build and develop a scientific community around the node. The https://www.gbif.org/resource/search?contentType=literature&literatureType=journal&relevance=GBIF_USED&peerReview=true[country filter] of literature tracking and annual https://www.gbif.org/data-use[_Science Review_] can help identify active users of GBIF-mediated data in the country.
